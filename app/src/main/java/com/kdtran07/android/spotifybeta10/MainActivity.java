...
/**
 *All of the codes here are pre-written. Pranavi was sitting behind me as I attempt to fix
 * alls the compile errors. The following compile erros are just button assignments in UI
 * which were taken off for furthering our codes in SpotifyBeta10V2
 *
 */
package com.kdtran07.android.spotifybeta10;
...
public class MainActivity extends Activity implements
    ...
    private void openLoginWindow() {
        final AuthenticationRequest request = new AuthenticationRequest.Builder(CLIENT_ID, AuthenticationResponse.Type.TOKEN, REDIRECT_URI)
                .setScopes(new String[]{"user-read-private", "playlist-read", "playlist-read-private", "streaming",
                        "playlist-modify-private", "user-follow-modify", "user-follow-read", "user-library-read",
                        "user-library-modify", "user-read-bitrate", "user-read-email"})
                .build();
        ...
        if (mPlayer == null) {
            ...
            mPlayer = Spotify.getPlayer(playerConfig, this, new Player.InitializationObserver() {
                ...
                public void onInitialized(Player player) {
                    ...
                    mPlayer.setConnectivityStatus(getNetworkConnectivity(MainActivity.this));
                    mPlayer.addPlayerNotificationCallback(MainActivity.this);
                    mPlayer.addConnectionStateCallback(MainActivity.this);
                    // Trigger UI refresh
                    updateButtons();
    ...
    private void updateButtons() {
        ...
        if (loggedIn) loginButton.setText(getString(R.string.logout_button_label1));
        else loginButton.setText(getString(R.string.login_button_label1));
    ...
    protected void onPause() {
        ...
        // paused.
        if (mPlayer != null) {
            mPlayer.removePlayerNotificationCallback(MainActivity.this);
